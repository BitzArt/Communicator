...
{
    /// <inheritdoc cref="IUpdate{TModel, TKey}"/>/>
    public interface IUpdate<TModel>
    {
        /// <inheritdoc cref="IUpdate{TModel, TKey}.UpdateAsync{TInputParameters, TResponse}(TKey, TModel, TInputParameters, bool, CancellationToken)"/>
    ...
    public interface IUpdate<TModel, TKey>
    {
